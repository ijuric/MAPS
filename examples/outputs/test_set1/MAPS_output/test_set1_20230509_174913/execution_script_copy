...
if [ $organism == "mm10" ]; then
	if [ -z $bwa_index ]; then
        	bwa_index="/home/mishras10/mm10.fa"
	fi
	...
	if [ -z $bwa_index ]; then
		bwa_index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/mm9.fa"
	fi
	...
	if [ -z $bwa_index ]; then
		bwa_index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/hg19.fa"
	fi
	...
	if [ -z $bwa_index ]; then
		bwa_index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta"
	fi
